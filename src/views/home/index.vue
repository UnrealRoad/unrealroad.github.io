           ...
           <el-col :span="8" :offset="8">
               <div class="infinite-list-wrapper">
                   <ul class="infinite-list">
                       <li v-for="item in blog" class="infinite-list-item" :key="item.id" @click="openDrawer(item)">{{ item.title }}</li>
                   </ul>
       ...
       <el-drawer
           ...
           <el-row>
               <el-col :span="16" :offset="4">
                   <mavon-editor :toolbarsFlag="false" :subfield="false"  :shortCut="false" :editable="false"  defaultOpen="preview" codeStyle="dark" v-model="item.content" style="min-height: 666px" />
               </el-col>
           </el-row>
       </el-drawer>
   </div>
